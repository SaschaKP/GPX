#if defined(SERIAL_SUPPORT) && (defined(_WIN32) || defined(_WIN64))
/* termiWin.c
*
...
int __selectSerial(int nfds, fd_set *readfds, fd_set *writefds, fd_set *exceptfds, struct timeval *timeout) {
...
int __readFromSerial(int fd, char* buffer, int count) {
...
int __writeToSerial(int fd, char* buffer, int count) {
...
#define read __readFromSerial
#define write __writeToSerial
#define select __selectSerial
#define open __openSerial
#define close __closeSerial
#endif
